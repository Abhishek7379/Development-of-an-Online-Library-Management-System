    ...
    return (
        <div className='footer'>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2023 copyright all right reserved<br /><span>Designed with ❤️ by Abhishek Maurya</span></p>
            </div>
        </div>
    )
}
